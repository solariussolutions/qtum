...
#ifndef QUANTUM_PRIMITIVES_TRANSACTION_H
#define QUANTUM_PRIMITIVES_TRANSACTION_H
...
public:
    ...
    {
        return (nValue < GetDustThreshold(minRelayTxFee) && !this->scriptPubKey.HasOpExec() && !this->scriptPubKey.HasOpAssign());
    }
...
#endif // QUANTUM_PRIMITIVES_TRANSACTION_H
