...
public:
	...
	// Executive(State& _s, EnvInfo const& _envInfo): m_s(_s), m_envInfo(_envInfo){}
...
private:
	...
	std::shared_ptr<QuantumExtVM> m_ext;		///< The VM externality object for the VM execution or null if no VM is required. shared_ptr used only to allow ExtVM forward reference. This field does *NOT* survive this object.
	...
	unsigned m_depth = 0;				///< The context's call-depth. TODO: ???
