...
///////////////////////////////////////////////////////////////////////////////// // TODO temp QtumTransaction
class QtumTransaction : public Transaction{
...
public:
	...
	/// Constructs an unsigned message-call transaction.
	QtumTransaction(u256 const& _value, u256 const& _gasPrice, u256 const& _gas, Address const& _dest, bytes const& _data, u256 const& _nonce = Invalid256):
		Transaction(_value, _gasPrice, _gas, _dest, _data, _nonce)
	{}

	/// Constructs an unsigned contract-creation transaction.
	QtumTransaction(u256 const& _value, u256 const& _gasPrice, u256 const& _gas, bytes const& _data, u256 const& _nonce = Invalid256):
		Transaction(_value, _gasPrice, _gas, _data, _nonce)
	{}

	void setHashWith(h256 hashWith) const { m_hashWith = hashWith; } 

	h256 getHashWith() const { return m_hashWith; }

	void setVoutNumber(unsigned char _vout) { m_voutNumber = _vout; }

	unsigned char getVoutNumber() const { return m_voutNumber; };

	void setVersion(unsigned char _version) { m_version = _version; };

	unsigned char getVersion() const { return m_version; };

private:

	unsigned char m_voutNumber;
