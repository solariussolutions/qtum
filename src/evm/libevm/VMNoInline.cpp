...
void VM::throwOutOfGas() // TODO temp OutOfGas
{
	BOOST_THROW_EXCEPTION(OutOfGas());
}

void VM::throwBadInstruction() // TODO temp BadInstruction
{
	BOOST_THROW_EXCEPTION(BadInstruction());
}

void VM::throwBadJumpDestination() // TODO temp BadJumpDestination
{
...
// {
//     // printf("Yerror: %s\n", boost::diagnostic_information(x).c_str()); //e.what());
