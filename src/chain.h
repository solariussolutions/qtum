...
public:
   ...
   //end modif qtum
    ...
    void SetNull()
    {
        ...
        hashUTXORoot   = uint256(); // TODO temp rootQtum
    }
    ...
    CBlockIndex(const CBlockHeader& block)
    {
        ...
        hashUTXORoot   = block.hashUTXORoot; // TODO temp rootQtum
    }
    ...
    {
        //begin modif qtum
        return strprintf("CBlockIndex(pprev=%p, pnext=%p, nHeight=%d, nFlags=(%s)(%d)(%s), nStakeModifier=%016x, hashProof=%s, prevoutStake=(%s), nStakeTime=%d, merkle=%s, hashBlock=%s)",
            pprev, pnext, nHeight,
