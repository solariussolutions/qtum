...
#ifndef QUANTUM_TEST_SCRIPTNUM10_H
#define QUANTUM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Quantum Core 0.10.0, for cross-comparison.
 */
public:
