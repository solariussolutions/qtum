...
#ifndef QUANTUM_QT_QUANTUMUNITS_H
#define QUANTUM_QT_QUANTUMUNITS_H
...
/** Quantum unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class QuantumUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit QuantumUnits(QObject *parent);

    /** Quantum units.
      @note Source: https://en.quantum.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        QTUM,
...
typedef QuantumUnits::Unit QuantumUnit;

#endif // QUANTUM_QT_QUANTUMUNITS_H
