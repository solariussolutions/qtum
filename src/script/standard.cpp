...
bool Solver(const CScript& scriptPubKey, txnouttype& typeRet, vector<vector<unsigned char> >& vSolutionsRet)
{
    ...
    if (mTemplates.empty())
    {
        ...
        // Quantum address tx, sender provides hash of pubkey, receiver provides signature and pubkey
        mTemplates.insert(make_pair(TX_PUBKEYHASH, CScript() << OP_DUP << OP_HASH160 << OP_PUBKEYHASH << OP_EQUALVERIFY << OP_CHECKSIG));

        // Smart contract deploy tx, .
        //mTemplates.insert(make_pair(TX_DEPLOYMENT, CScript() << OP_EXTBC << OP_SMALLINTEGER << OP_EQUALVERIFY << OP_SWAP
...
//        return true;
//    }
//    else if(whichType == TX_ASSIGN_SC)
//    {
//        addressRet = CScriptID(uint160(vSolutions[0]));
//        return true;
//    }
...
{
   CScript script;
//    script << bc << CScriptNum(ver) << OP_EQUALVERIFY << OP_SWAP;
