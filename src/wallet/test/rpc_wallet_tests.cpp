...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CQuantumAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CQuantumAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CQuantumAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CQuantumAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CQuantumAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CQuantumAddress(arr[0].get_str()).Get() == demoAddress.Get());
