/* src/config/quantum-config.h.  Generated from quantum-config.h.in by configure.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Quantum Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Quantum Core"
...
#define PACKAGE_BUGREPORT "https://github.com/quantum/quantum/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Quantum Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Quantum Core 0.13.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "quantum"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://quantumcore.org/"
