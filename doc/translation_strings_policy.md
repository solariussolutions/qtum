...
This document provides guidelines for internationalization of the Quantum Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `quantum_en.ts` remains unchanged.
