...
class RawTransactionsTest(QuantumTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid quantum address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid quantum address" in e.error['message'])
